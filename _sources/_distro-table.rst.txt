...
.. NOTE::
   ...
   **Debian 13 (trixie)** is not supported yet: the ``grpcio`` version currently used by Pontoon cannot be built for Python 3.13.

.. WARNING::

   **Ubuntu 22.04 LTS (jammy)** is not supported anymore. Minimal requirements for
   Pontoon are now Python 3.11 and PostgreSQL 15.
